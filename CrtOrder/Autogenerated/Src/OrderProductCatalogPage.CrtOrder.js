		...
		viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/[
			{
				...
				"values": {
					...
					"EntityHierarchyFilter_NodesConfig": {
						"value": [
							{
								"columnName": "Category",
								"children": [
					...
					"EntityHierarchyFilter_ExpandedNodes": {
						"value": null
					},
					"EntityHierarchyFilter_SpecificationFilters": {
						"value": null
					},
					"EntityHierarchyFilter_SpecificationFiltersConfiguration": {
						"value": []
					},
					"EntityHierarchyFilter_SelectedTabInd": {
						"value": 0
					},
					"EntityHierarchyFilter_Filters": {
						"from": [
							"EntityHierarchyFilter_SelectedNode",
							"EntityHierarchyFilter_SpecificationFilters"
						],
						"converter": "crt.ToHierarchyFiltersConverter : 'Product' : 'EntityHierarchyFilter_Nodes'",
						"filter": "crt.ToBoolean : $EntityHierarchyFilter_SelectedNode"
					},
					"EntityHierarchyFilter_Nodes": {
						"from": [
							"EntityHierarchyFilter_NodesConfig",
							"EntityHierarchyFilter_ExpandedNodes",
							"EntityHierarchyFilter_PredefinedFilter"
						],
						"converter": "crt.ToHierarchyNodesConverter : 'Product' : 'EntityHierarchyFilter_Nodes' : 'EntityHierarchyFilter_PredefinedFilter'"
					},
					"EntityHierarchyFilter_SelectedNodeId": {
						"from": [
							"EntityHierarchyFilter_SelectedNodeId_Profile",
							"EntityHierarchyFilter_PredefinedFilter"
						],
						"converter": "crt.HierarchyCheckSelectedNodeExistsConverter : 'Product' : 'EntityHierarchyFilter_NodesConfig' : 'EntityHierarchyFilter_Nodes'",
						"change": [
							{
								"request": "crt.SaveAttributeToProfileRequest",
								"params": {
									"profileAttributeName": "EntityHierarchyFilter_SelectedNodeId"
								}
							}
						]
					},
					"EntityHierarchyFilter_ExpandedItems": {
						"change": [
							{
								"request": "crt.SaveAttributeToProfileRequest",
								"params": {
									"profileAttributeName": "EntityHierarchyFilter_ExpandedItems"
								}
							}
						]
					},
						...
						"change": [
							{
								"request": "crt.SaveAttributeToProfileRequest",
								"params": {
									"profileAttributeName": "EntityHierarchyFilter_SelectedNodeId_Profile"
								}
							}
						]
					}
