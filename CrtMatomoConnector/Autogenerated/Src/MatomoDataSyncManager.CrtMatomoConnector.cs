namespace Terrasoft.Configuration
{
	...
	public class MatomoDataSyncManager
	{
		...
		private IEnumerable<MatomoTouchModel> GetVisitorsToSync() {
		...
		private IEnumerable<int> GetSiteIds(List<MatomoTouchModel> visitors = null) {
