namespace Terrasoft.Configuration
{
	...
	public class UpdateEventEditPageForShellScriptExecutor : IInstallScriptExecutor
	{
		private readonly string _entitySchemaName = "Event";
		private readonly Guid _freedomUI = Guid.Parse("F4D757E1-2AEB-496F-B751-3D5B39708EA3");

		private void UpdateEventEditPage(UserConnection userConnection) {
		...
		public void Execute(UserConnection userConnection) {
			UpdateEventEditPage(userConnection);
		}
	}
}
