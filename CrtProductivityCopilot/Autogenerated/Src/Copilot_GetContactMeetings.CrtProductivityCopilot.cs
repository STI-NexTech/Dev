namespace Terrasoft.Core.Process
{
	...
	#region Class: Copilot_GetContactMeetingsMethodsWrapper

	/// <exclude/>
	public class Copilot_GetContactMeetingsMethodsWrapper : ProcessModel
	{

		public Copilot_GetContactMeetingsMethodsWrapper(Process process)
			: base(process) {
