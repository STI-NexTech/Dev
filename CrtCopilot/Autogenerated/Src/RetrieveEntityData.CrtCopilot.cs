namespace Terrasoft.Core.Process
{
	...
	#region Class: RetrieveEntityDataMethodsWrapper

	/// <exclude/>
	public class RetrieveEntityDataMethodsWrapper : ProcessModel
	{

		public RetrieveEntityDataMethodsWrapper(Process process)
			: base(process) {
